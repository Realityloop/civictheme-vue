import CTNavigationCard from './NavigationCard.vue'

export default {
  title: 'CivicTheme/Molecules/Cards/Navigation Card',
  component: CTNavigationCard,
  argTypes: {
    theme: {
      options: ['dark', 'light'],
      control: 'select'
...
const Template = (args, { argTypes }) => {
  return {
    ...
    template: `<CTNavigationCard v-bind="$props" v-on="$props">
